...
let mail = document.getElementById("email-to")
let lecheBoule = document.getElementById("apple");
let y = 25;
...
btnUpload.addEventListener("click", function(e){
    ...
    formData.append('email-to', mail.value );
...
lecheBoule.addEventListener("click", function(e){
    e.preventDefault()
